    ...
    <div class="container page">
        ...
        <div class="col-md-10 offset-md-1 col-xs-12">
            ...
            <fieldset>
                ...
                <fieldset class="form-group">
                    <input type="text" class="form-control" v-model="tag" @keyup.enter="addTag" placeholder="Enter tags"><div class="tag-list"></div>
                    <span v-for="(item,index) in article.tagList" style="margin:5px" :key="item+index">{{item}}</span>
                </fieldset>
...
<script>
import {createArticles} from '@/apis/acrticle'
export default {
    name:'editor',
    middleware:['auth'],
    data(){
