  ...
  <div>
      ...
      <div class="container">
        ...
        <ul class="nav navbar-nav pull-xs-right">
          ...
          <template v-else>
            <li class="nav-item">
            <nuxt-link class="nav-link" exact to="/login">Sign in</nuxt-link>
            </li>
            <li class="nav-item">
            <nuxt-link class="nav-link" exact to="/register">Sign up</nuxt-link>
            </li>
          </template>
        </ul>
      </div>
    ...
    <footer>
      <div class="container">
        <nuxt-link  to="/" exact class="logo-font">conduit</nuxt-link>
